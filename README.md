...
TTGTiSO-Test — настольный комплекс для проведения экзаменов / контрольных в учебных аудиториях. Сервер у преподавателя, клиент-киоск у каждого студента, всё в локальной сети.
...
TTGTiSO-Test делает несколько вещей, которые отсутствовали в более ранних версиях:
